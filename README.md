...
A simple one header solution to unit testing for C/C++, by [Neil Henning](https://github.com/sheredom).
...
```c
#include "node_modules/utest-h.c/utest.h"
```
...
![](https://ga-beacon.deno.dev/G-RC63DPBH3P:SH3Eq-NoQ9mwgYeHWxu7cw/github.com/nodef/utest-h.c)
[![SRC](https://img.shields.io/badge/src-repo-green?logo=Org)](https://github.com/sheredom/utest.h)
